...
export const CANDOR_ITEMS: { id: string; axis: 'care' | 'challenge'; text: string }[] = [
  { id: 'care_1', axis: 'care', text: '{name} genuinely cares about people as people, not just the work they produce.' },
  ...
  { id: 'challenge_2', axis: 'challenge', text: '{name} gives honest, specific feedback even when it might be uncomfortable.' },
