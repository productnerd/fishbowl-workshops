...
=== VOICE ===
Talk about "the team" and "you" (the manager). Warm, direct, specific, never generic. No filler, no dashes (never "—"/"–"/" - " as a connector; use commas/periods). Wrap 2 to 3 key phrases per item in **bold**.
